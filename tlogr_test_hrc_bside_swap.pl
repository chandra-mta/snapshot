...
$work_dir = "/home/malgosia/git/snapshot";
$web_dir = "/home/malgosia/git/snapshot";
#$web_dir = "/proj/ascwww/AXAF/extra/science/cgi-gen/mta/Snap";
#$wap_dir = "/data/mta4/www/WL/Snap_dat";
$wap_dir = "/home/malgosia/git/snapshot";
...
# check state
#use check_state;
use check_state_test_hrc_bside_swap;
#use check_state_sim;
%h = check_state(%h);
...
write_wap(%h);
write_wap_arc(%h);
$snapf = "/home/malgosia/git/snapshot/snap_curr.wml";
open(SF,">$snapf") or die "Cannot open $snapf\n";
